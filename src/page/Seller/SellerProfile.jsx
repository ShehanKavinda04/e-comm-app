...
import MyProduct from './SellerPagesComponent/MyProduct';
import Orders from './SellerPagesComponent/Orders'
import Analytics from './SellerPagesComponent/Analytics'
  ...
  return (
     <div className='pt-[110px] w-full ms:h-full  md:h-screen md:overflow-scroll sm:overflow-hidden bg-gray-300 '>
        <div className='flex flex-col md:flex-row md:items-center gap-5 justify-between mb-5'>
          <div>
            <p className='text-5xl text-black font-normal mb-2 sm:ml-5 md:ml-14'>Hello Mr. Seller</p>
            <p className='text-gray-700 font-medium sm:ml-5 md:ml-14'>Manage your product and track your seller</p>
          </div>
        ...
        {whoIsClick.My_Product && <MyProduct/>}
   ...
   const clickHandle=()=>{
    ...
    switch (name) {
      ...
      case 'Overview':
        ...
        break
      case 'Advertisement':
        obj.Advertisement = true,
        obj.Overview =false
        break
      case 'Store_Setting':
        obj.Store_Setting = true,
        obj.Overview =false
        break
      default:
        obj.Overview = true
